<template>
  <div class="article">
        ...
        <el-main style="background: white; margin-right: 10px">
          <div class="Focus">
            <div class="Img">
              ...
              <span>{{this.$store.state.articleCon.data.author.name}}</span>
              <span class="date">{{this.$store.state.articleCon.data.date | formatDate }}</span>
            </div>
          </div>
          <el-header class="title">
            <h2>{{this.$store.state.articleCon.data.title}}</h2>
          </el-header>
          <el-main>
            <div>
              <p v-html="this.$store.state.articleCon.data.content"></p>
            </div>
          </el-main>
        </el-main>
      </el-container>
    ...
    <div class="articleLabel">
      <span v-html="this.$store.state.articleCon.data.label"></span>
    </div>
    <div class="con">
      <el-container>
        <el-main style="background: white; margin-right: 10px">
  ...
  export default {
    ...
    methods:{
      ...
      onSubmit() {
        ...
        let articleId = this.$store.state.articleCon.data._id;
        this.$http.post('/comments',{
          ...
          this.$http.post('/access/comments',{articleId}).then(res=>{
      ...
      //点赞
      giveLike(){
        let _id = this.$store.state.articleCon.data._id;
        if (this.getLike) {
    ...
    created(){
      ...
      //点赞
      let getLikeId = this.$store.state.articleCon.data._id;
